...
export class MockNbaService {
    ...
    getAllTeams(): Observable<Team[]> {
        return of(TEAMS_RESPONSE);
    }
    getLastResults(team: Team, numberOfDays = 12): Observable<Game[]> {
        return of([]);
    }
    getStatsFromGames(games: Game[], team: Team): Stats {
        return { wins: 0, losses: 0, averagePointsScored: 0, averagePointsConceded: 0, lastGames: [] };
    }
}
...
export class MockOptionsListComponent {
    @Input()
    value: string = '';
    @Input()
